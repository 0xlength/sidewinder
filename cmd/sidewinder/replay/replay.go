...
import (
	...
	"github.com/0xlength/sidewinder/pkg/genesis"
	"github.com/0xlength/sidewinder/pkg/merkletree"
	"github.com/0xlength/sidewinder/pkg/poh"
...
func init() {
	...
	flags.StringVar(&flagDB, "db", "", "Path to blockstore")
}
